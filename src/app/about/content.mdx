...
## Background
I'm an only child in my family and lived most of my life moving around to different places to live because of my parents' jobs.
...
cause of my potato brain 🥔. A few months later, I clung to my dad and begged him to buy me a laptop. And he made the mistake.
...
I coded out the UIs of a few web pages for practice (e.g.: Facebook login page, DigiKala's homepage, MacDonalds's homepage, Apple's homepage, etc.).
...
I began building personal projects with PHP and my brain somehow stopped being a potato and I self-studied more advanced
concepts in PHP. Then I started building more projects for my friends, family, and freelancing. I ended up making my own
PHP framework because I didn't want to learn any frameworks back then! And, unsurprisingly, it was not the best decision
even though it was super fun.

PHP was not the only language I learned, but it was my stepping stone to learn languages such as: C#, Java, JavaScript,
Python, and C++. Not an impressive stepping stone but whatever.

I tried learning more about Cybersecurity concepts and self-studied some stuff from OWASP. But, I never gone too far as to
hack CTFs as a hobby because my Operation System and Networking knowledge was not the best. My excuse is that my brain
was not fully developed and I literally could not understand no matter how many times I read something. I needed a mentor
most-likely. I learned more about different techniques and attacks in Cybersecurity and familiarized myself with linux,
networking concepts, web application vulnerabilities, and stuff like that.

I never had a chance to learn JavaScript at a fundamental level until I went to the college. From there, I met lots of
peers and actually started working as a team. I learned the basics of Operation Systems, Databases, and Programming once
more which really reinforced those stuff for me at a basic level. I think going to a college was super nice
because of this. Maybe that's why some jobs require you to have a degree.
