    ...
    <div className={`flex w-full flex-col items-center justify-center`}>
      <div className={`flex w-10/12 justify-around pt-10 md:w-8/12 lg:w-5/12`}>
        ...
        >
          <DiamondCube
            text={'LinkedIn'}
            containerClassName={`grayscale hover:grayscale-0 contactDiamondCube bg-gradient-to-br from-[#0b66c3] via-[#3b82f6] to-[#93c5fd] cursor-pointer`}
          />
        </Link>
        <Link href={'https://github.com/iliaamiri'} target={'_blank'}>
          <DiamondCube
            text={'GitHub'}
            containerClassName={`grayscale hover:grayscale-0 contactDiamondCube  bg-gradient-to-br from-[#24292e] via-[#0366d6] to-[#f6f8fa] cursor-pointer`}
          />
        </Link>
      </div>
      <div className={`flex w-7/12 justify-around pt-10 md:w-5/12 lg:w-3/12`}>
