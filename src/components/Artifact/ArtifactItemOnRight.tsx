...
export function ArtifactItemOnRight({ artifact }: { artifact: ArtifactModel }) {
  return (
    <div className={`flex w-full flex-col justify-end md:flex-row`}>
      <div
        className={`flex w-full flex-col items-start justify-start pt-10 md:w-7/12`}
      >
        <div
      ...
      >
        <div className={`relative w-fit self-center justify-self-center`}>
          <div
            className={`absolute top-0 z-10 flex h-[400px] w-[400px] shrink-0 grow-0 rotate-45 flex-col justify-between overflow-hidden rounded-2xl bg-primaryDawn`}
          >
            <div>
              <SkillBadgeRow
