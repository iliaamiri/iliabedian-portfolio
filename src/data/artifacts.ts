...
export const artifacts: Record<string, ArtifactModel> = {
  igaq: {
    ...
    technologies: [
      {
        list: [
          ...
          technologies['Neo4j'],
          technologies['Git'],
          technologies['Pusher.js'],
          technologies['MVC'],
          technologies['Event-driven Architecture'],
        ],
        shouldMarquee: true,
      },
      {
        list: [
          ...
          technologies['Serverless Functions'],
          technologies['Vercel'],
    ...
    categories: [
      ArtifactCategory.FullStack,
      ArtifactCategory.BackEnd,
      ArtifactCategory.CyberSecurity,
    ],
  },
  interviewpal: {
    id: 3,
  ...
  'icbc-slot-sniper': {
    ...
    summaryText:
      'A web bot that finds the closest time for an ICBC Road Test. It uses Selenium to automate the process of booking an appointment' +
      'all by itself. It can read your inbox and scan the verification code sent by ICBC.',
    technologies: [
      {
        list: [
          technologies['JavaScript'],
          technologies['SeleniumUI'],
          technologies['Docker'],
          technologies['GitHub'],
        ],
        shouldMarquee: false,
    ...
    githubUrl:
      'https://github.com/iliaamiri/a-web-bot-for-booking-the-closest-possible-appointment-on-ICBC-Driver-Licensing',
    demoUrl:
      'https://github.com/iliaamiri/a-web-bot-for-booking-the-closest-possible-appointment-on-ICBC-Driver-Licensing',
  ...
  'pixel-art': {
    ...
    slug: 'pixel-art',
    summaryText:
      'A website built with Next.js and Prisma. Users can create pixel art and share it with others. It uses Next Auth for ' +
