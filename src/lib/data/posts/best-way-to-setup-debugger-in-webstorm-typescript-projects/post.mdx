...
Now, you're done! Hit the play button and you're good to go! Again, don't forget to set breakpoints 🤗

I'm planning to make another blog showcasing how to use the debugger and how to debug your code. So, stay tuned for that!

If you have any questions, feel free to reach out to me via twitter, or email. I'm always happy to help! ❣️
